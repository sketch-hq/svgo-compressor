...
If you want your SVG assets uncompressed, you can temporarily disabled the Plugin by opening Sketch's Preferences › Plugins and unchecking 'SVGO Compressor'. Alternatively, you can right-click any layer and select **Copy SVG Code**, and that will give you the original, uncompressed code.
